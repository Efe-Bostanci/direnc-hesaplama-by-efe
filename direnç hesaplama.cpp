	...
	while (1)
	{
		...
		if (islem == "direnc")
		{
			...
			if (serit == "4") //4 þeritli direnç hesaplama bölümü
			{
				...
				cout << ((birincis * 10) + ikincis) * ucuncus << " Ohm ?" << endl; //4þeritli iþlem hesaplama bölümü
			}
			...
			if (serit == "5") //5 þeritli direnç hesaplama bölümü
			{
				...
				cout << ((birincis * 100) + (ikincis * 10) + ucuncus) * dorduncus << " Ohm ?" << endl; //5þeritli iþlem hesaplama bölümü
			}
			...
			if (serit == "6") //6 þeritli direnç hesaplama bölümü
			{
				...
				cout << ((birincis * 100) + (ikincis * 10) + ucuncus) * dorduncus << " Ohm ?" << endl; //6þeritli iþlem hesaplama bölümü
				cout << "son banttaki deger sicakliga duyarliliktir " << endl << "formul: (ppm/C deðeri)×(Direnç deðeri)/1000000 " << endl;
		}
	}
  } 
}